...
public class BDData extends SQLiteOpenHelper {
    final String CREATE_FAMILIES_TABLE = "CREATE TABLE FAMILIES (LATITUD TEXT, LONGITUD TEXT, FECHA TEXT)";
    final String CREATE_AEDES_TABLE = "CREATE TABLE AEDES (LATITUD TEXT, LONGITUD TEXT, FECHA TEXT, ENCUESTADOR TEXT)";
    final String CREATE_PERSONS_TABLE = "CREATE TABLE PERSONS (LATITUD TEXT, LONGITUD TEXT, FECHA TEXT," +
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_AEDES_TABLE);
        db.execSQL(CREATE_CACHE);
        db.execSQL(CREATE_DOMICILIO);
        db.execSQL(CREATE_CACHE_UD);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS AEDES");
        db.execSQL("DROP TABLE IF EXISTS DOMICILIO");
        db.execSQL("DROP TABLE IF EXISTS CACHEUD");
        onCreate(db);
    }

    public void CrearTablaUnificados(){
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("CREATE TABLE IF NOT EXISTS FAMILIES (LATITUD TEXT, LONGITUD TEXT, FECHA TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS PERSONS (LATITUD TEXT, LONGITUD TEXT, FECHA TEXT," +
                "NOMBRE TEXT, APELLIDO TEXT, DNI TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS CACHE (TEXT FECHA)");
        db.execSQL("CREATE TABLE IF NOT EXISTS AEDES (LATITUD TEXT, LONGITUD TEXT, FECHA TEXT, ENCUESTADOR TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS DOMICILIO (LATITUD TEXT, LONGITUD TEXT, FECHA TEXT)");
