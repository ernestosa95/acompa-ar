...
public class TrabajosSearchAdapter extends ArrayAdapter<String> {
    ...
    private class stringsFilter extends Filter {
        private TrabajosSearchAdapter searchAdapter;
        private Context context;

        public stringsFilter(TrabajosSearchAdapter searchAdapter, Context context){
            super();
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint == null || constraint.length()==0){
                ...
                List<String> resultadosBD = admin.BuscarTrabajo(constraint.toString());
    ...
    public TrabajosSearchAdapter(@NonNull Context context, List<String> strings) {
