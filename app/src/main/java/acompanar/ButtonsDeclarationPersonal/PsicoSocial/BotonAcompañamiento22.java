...
public class BotonAcompañamiento22 implements Serializable {
    Context context;
    ...
    public BotonAcompañamiento22(Context originalContext, View view, String title){
    ...
    public void vista(){
        ...
        View RE13 = buttonViewBasic.generateOptionsCheckbox(context, options.get("RE13_0"), buttonViewBasic.getSubOptions(options, "RE13"));
        lyOptions.addView(RE13);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                data.putAll(buttonViewBasic.getValueCheckBox(RE13));
